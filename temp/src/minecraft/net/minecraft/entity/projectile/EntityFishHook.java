      ...
      if(this.field_146055_aB > 0) {
         ...
         if(!this.field_146051_au) {
            ...
            for(int var35 = 0; var35 < var33; ++var35) {
               double var14 = this.field_70121_D.field_72338_b + (this.field_70121_D.field_72337_e - this.field_70121_D.field_72338_b) * (double)(var35 + 0) / (double)var33 - 0.125D + 0.125D;
               double var16 = this.field_70121_D.field_72338_b + (this.field_70121_D.field_72337_e - this.field_70121_D.field_72338_b) * (double)(var35 + 1) / (double)var33 - 0.125D + 0.125D;
            ...
            if(!this.field_70170_p.field_72995_K && var32 > 0.0D) {
               WorldServer var34 = (WorldServer)this.field_70170_p;
               int var36 = 1;
               ...
               if(this.field_146045_ax > 0) {
                  ...
                  if(this.field_146038_az > 0) {
                     ...
                     if(this.field_146038_az <= 0) {
                        ...
                        var34.func_147487_a("bubble", this.field_70165_t, (double)(var15 + 1.0F), this.field_70161_v, (int)(1.0F + this.field_70130_N * 20.0F), (double)this.field_70130_N, 0.0D, (double)this.field_70130_N, 0.20000000298023224D);
                        var34.func_147487_a("wake", this.field_70165_t, (double)(var15 + 1.0F), this.field_70161_v, (int)(1.0F + this.field_70130_N * 20.0F), (double)this.field_70130_N, 0.0D, (double)this.field_70130_N, 0.20000000298023224D);
                     ...
                     if(this.field_70146_Z.nextFloat() < var15) {
                        ...
                        var34.func_147487_a("splash", var38, var20, var22, 2 + this.field_70146_Z.nextInt(2), 0.10000000149011612D, 0.0D, 0.10000000149011612D, 0.0D);
                     }
