...
public abstract class Entity {
   ...
   public void func_70091_d(double p_70091_1_, double p_70091_3_, double p_70091_5_) {
      if(this.field_70145_X) {
         ...
         List var37 = this.field_70170_p.func_72945_a(this, this.field_70121_D.func_72321_a(p_70091_1_, p_70091_3_, p_70091_5_));

         for(int var22 = 0; var22 < var37.size(); ++var22) {
            p_70091_3_ = ((AxisAlignedBB)var37.get(var22)).func_72323_b(this.field_70121_D, p_70091_3_);
         }
         ...
         for(var23 = 0; var23 < var37.size(); ++var23) {
            p_70091_1_ = ((AxisAlignedBB)var37.get(var23)).func_72316_a(this.field_70121_D, p_70091_1_);
         }
         ...
         for(var23 = 0; var23 < var37.size(); ++var23) {
            p_70091_5_ = ((AxisAlignedBB)var37.get(var23)).func_72322_c(this.field_70121_D, p_70091_5_);
         }
         ...
         if(this.field_70138_W > 0.0F && var36 && (var20 || this.field_70139_V < 0.05F) && (var13 != p_70091_1_ || var17 != p_70091_5_)) {
            ...
            var37 = this.field_70170_p.func_72945_a(this, this.field_70121_D.func_72321_a(var13, p_70091_3_, var17));

            for(var30 = 0; var30 < var37.size(); ++var30) {
               p_70091_3_ = ((AxisAlignedBB)var37.get(var30)).func_72323_b(this.field_70121_D, p_70091_3_);
            }
            ...
            for(var30 = 0; var30 < var37.size(); ++var30) {
               p_70091_1_ = ((AxisAlignedBB)var37.get(var30)).func_72316_a(this.field_70121_D, p_70091_1_);
            }
            ...
            for(var30 = 0; var30 < var37.size(); ++var30) {
               p_70091_5_ = ((AxisAlignedBB)var37.get(var30)).func_72322_c(this.field_70121_D, p_70091_5_);
            }
         ...
         if(this.func_70041_e_() && !var20 && this.field_70154_o == null) {
            int var40 = MathHelper.func_76128_c(this.field_70165_t);
            ...
            Block var32 = this.field_70170_p.func_147439_a(var40, var30, var31);
            int var33 = this.field_70170_p.func_147439_a(var40, var30 - 1, var31).func_149645_b();
            if(var33 == 11 || var33 == 32 || var33 == 21) {
               var32 = this.field_70170_p.func_147439_a(var40, var30 - 1, var31);
            }
            ...
            if(this.field_82151_R > (float)this.field_70150_b && var32.func_149688_o() != Material.field_151579_a) {
               ...
               var32.func_149724_b(this.field_70170_p, var40, var30, var31, this);
            }
         }
         ...
         try {
            ...
            CrashReportCategory var39 = var42.func_85058_a("Entity being checked for collision");
            this.func_85029_a(var39);
            throw new ReportedException(var42);
         }

         boolean var41 = this.func_70026_G();
