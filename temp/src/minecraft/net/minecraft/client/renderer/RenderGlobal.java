...
public class RenderGlobal implements IWorldAccess {
   ...
   private int func_72724_a(int p_72724_1_, int p_72724_2_, int p_72724_3_, double p_72724_4_) {
      ...
      EntityLivingBase var23 = this.field_72777_q.field_71451_h;
      double var22 = var23.field_70142_S + (var23.field_70165_t - var23.field_70142_S) * p_72724_4_;
      double var13 = var23.field_70137_T + (var23.field_70163_u - var23.field_70137_T) * p_72724_4_;
      double var15 = var23.field_70136_U + (var23.field_70161_v - var23.field_70136_U) * p_72724_4_;
      int var17 = 0;
      ...
      for(var18 = 0; var18 < this.field_72755_R.size(); ++var18) {
         ...
         if(var20 < 0) {
            var20 = var17++;
            this.field_72754_S[var20].func_78422_a(var19.field_78918_f, var19.field_78919_g, var19.field_78931_h, var22, var13, var15);
         }
               ...
               if(p_72726_1_.equals("bubble")) {
                  ...
                  if(p_72726_1_.startsWith("iconcrack_")) {
                     ...
                     if(p_72726_1_.startsWith("blockcrack_")) {
                        ...
                        var26 = Integer.parseInt(var28[2]);
                        var21 = (new EntityDiggingFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, var27, var26)).func_90019_g(var26);
                     } else if(p_72726_1_.startsWith("blockdust_")) {
                        var28 = p_72726_1_.split("_", 3);
                        var27 = Block.func_149729_e(Integer.parseInt(var28[1]));
                        var26 = Integer.parseInt(var28[2]);
                        var21 = (new EntityBlockDustFX(this.field_72769_h, p_72726_2_, p_72726_4_, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_, var27, var26)).func_90019_g(var26);
                     }
                  }
               }
   ...
   public void func_72706_a(EntityPlayer p_72706_1_, int p_72706_2_, int p_72706_3_, int p_72706_4_, int p_72706_5_, int p_72706_6_) {
      ...
      case 2000:
         ...
         double var36 = (double)p_72706_5_ + (double)var10 * 0.6D + 0.5D;
      ...
      case 2003:
         ...
         for(double var35 = 0.0D; var35 < 6.283185307179586D; var35 += 0.15707963267948966D) {
            this.func_72708_a("portal", var9 + Math.cos(var35) * 5.0D, var11 - 0.4D, var13 + Math.sin(var35) * 5.0D, Math.cos(var35) * -5.0D, 0.0D, Math.sin(var35) * -5.0D);
            this.func_72708_a("portal", var9 + Math.cos(var35) * 5.0D, var11 - 0.4D, var13 + Math.sin(var35) * 5.0D, Math.cos(var35) * -7.0D, 0.0D, Math.sin(var35) * -7.0D);
         }
