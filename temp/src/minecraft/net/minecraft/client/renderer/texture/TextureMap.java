...
public class TextureMap extends AbstractTexture implements ITickableTextureObject, IIconRegister {
   ...
   public void func_110571_b(IResourceManager p_110571_1_) {
      ...
      Iterator var26 = this.field_110574_e.values().iterator();
      ...
      while(var26.hasNext()) {
         ...
         try {
            ...
            CrashReportCategory var32 = var29.func_85058_a("Sprite being mipmapped");
            var32.func_71500_a("Sprite name", new Callable() {
            ...
            var32.func_71500_a("Sprite size", new Callable() {
            ...
            var32.func_71500_a("Sprite frames", new Callable() {
            ...
            var32.func_71507_a("Mipmap levels", Integer.valueOf(this.field_147636_j));
      ...
      HashMap var25 = Maps.newHashMap(this.field_110574_e);
      ...
      while(var28.hasNext()) {
         ...
         try {
            ...
            CrashReport var31 = CrashReport.func_85055_a(var18, "Stitching texture atlas");
            CrashReportCategory var33 = var31.func_85058_a("Texture being stitched together");
