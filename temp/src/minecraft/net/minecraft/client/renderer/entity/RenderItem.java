...
public class RenderItem extends Render {
   ...
   public void func_76986_a(EntityItem p_77014_1_, double p_77014_2_, double p_77014_4_, double p_77014_6_, float p_77014_8_, float p_77014_9_) {
      ...
      if(var10.func_77973_b() != null) {
         ...
         if(var10.func_94608_d() == 0 && var10.func_77973_b() instanceof ItemBlock && RenderBlocks.func_147739_a(Block.func_149634_a(var10.func_77973_b()).func_149645_b())) {
            Block var21 = Block.func_149634_a(var10.func_77973_b());
            ...
            float var25 = 0.25F;
            var24 = var21.func_149645_b();
            if(var24 == 1 || var24 == 19 || var24 == 12 || var24 == 2) {
               var25 = 0.5F;
            }

            if(var21.func_149701_w() > 0) {
            ...
            for(int var26 = 0; var26 < var13; ++var26) {
               ...
               if(var26 > 0) {
                  ...
                  float var20 = (this.field_77025_h.nextFloat() * 2.0F - 1.0F) * 0.2F / var25;
                  GL11.glTranslatef(var18, var19, var20);
               }

               this.field_147913_i.func_147800_a(var21, var10.func_77960_j(), 1.0F);
               GL11.glPopMatrix();
            }
            ...
            if(var10.func_94608_d() == 1 && var10.func_77973_b().func_77623_v()) {
               ...
               for(int var23 = 0; var23 <= 1; ++var23) {
                  this.field_77025_h.setSeed(187L);
                  IIcon var22 = var10.func_77973_b().func_77618_c(var10.func_77960_j(), var23);
                  if(this.field_77024_a) {
                     var24 = var10.func_77973_b().func_82790_a(var10, var23);
                     ...
                     this.func_77020_a(p_77014_1_, var22, var13, p_77014_9_, var17, var18, var19);
                  } else {
   ...
   public void func_77015_a(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_, int p_77015_4_, int p_77015_5_) {
      ...
      if(p_77015_3_.func_94608_d() == 0 && RenderBlocks.func_147739_a(Block.func_149634_a(p_77015_3_.func_77973_b()).func_149645_b())) {
         ...
         Block var15 = Block.func_149634_a(p_77015_3_.func_77973_b());
         GL11.glPushMatrix();
         ...
         this.field_147913_i.func_147800_a(var15, var6, 1.0F);
         ...
         if(var7 == null) {
            var7 = ((TextureMap)Minecraft.func_71410_x().func_110434_K().func_110581_b(var16)).func_110572_b("missingno");
         }
