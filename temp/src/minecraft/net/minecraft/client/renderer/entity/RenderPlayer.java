...
public class RenderPlayer extends RendererLivingEntity {
   ...
   protected void func_77029_c(AbstractClientPlayer p_77100_1_, float p_77100_2_) {
      ...
      if(var21 && !p_77100_1_.func_82150_aj() && !p_77100_1_.func_82238_cc()) {
         ...
         double var25 = p_77100_1_.field_71091_bM + (p_77100_1_.field_71094_bP - p_77100_1_.field_71091_bM) * (double)p_77100_2_ - (p_77100_1_.field_70169_q + (p_77100_1_.field_70165_t - p_77100_1_.field_70169_q) * (double)p_77100_2_);
      ...
      ItemStack var23 = p_77100_1_.field_71071_by.func_70448_g();
      if(var23 != null) {
         GL11.glPushMatrix();
         this.field_77109_a.field_78112_f.func_78794_c(0.0625F);
         GL11.glTranslatef(-0.0625F, 0.4375F, 0.0625F);
         if(p_77100_1_.field_71104_cf != null) {
            var23 = new ItemStack(Items.field_151055_y);
         }

         EnumAction var24 = null;
         if(p_77100_1_.func_71052_bv() > 0) {
            var24 = var23.func_77975_n();
         }

         if(var23.func_77973_b() instanceof ItemBlock && RenderBlocks.func_147739_a(Block.func_149634_a(var23.func_77973_b()).func_149645_b())) {
            var7 = 0.5F;
            ...
            GL11.glScalef(-var7, -var7, var7);
         } else if(var23.func_77973_b() == Items.field_151031_f) {
            var7 = 0.625F;
            ...
            GL11.glRotatef(45.0F, 0.0F, 1.0F, 0.0F);
         } else if(var23.func_77973_b().func_77662_d()) {
            var7 = 0.625F;
            if(var23.func_77973_b().func_77629_n_()) {
         ...
         float var29;
         int var28;
         if(var23.func_77973_b().func_77623_v()) {
            for(var28 = 0; var28 <= 1; ++var28) {
               int var8 = var23.func_77973_b().func_82790_a(var23, var28);
               ...
               this.field_76990_c.field_78721_f.func_78443_a(p_77100_1_, var23, var28);
            }
         } else {
            var28 = var23.func_77973_b().func_82790_a(var23, 0);
            ...
            this.field_76990_c.field_78721_f.func_78443_a(p_77100_1_, var23, 0);
         }
