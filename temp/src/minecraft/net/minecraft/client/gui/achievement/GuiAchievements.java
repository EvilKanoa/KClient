   ...
   protected void func_146552_b(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      for(var22 = 0; var22 < AchievementList.field_76007_e.size(); ++var22) {
         ...
         if(var35.field_75992_c != null) {
            ...
            var43 = var35.field_75992_c.field_75993_a * 24 - var4 + 11;
            ...
            if(var30 <= 4) {
               ...
               this.func_73730_a(var24, var43, var25, var31);
               this.func_73728_b(var43, var25, var27, var31);
               if(var24 > var43) {
      ...
      int var42;
      int var40;
      for(var43 = 0; var43 < AchievementList.field_76007_e.size(); ++var43) {
         Achievement var41 = (Achievement)AchievementList.field_76007_e.get(var43);
         var40 = var41.field_75993_a * 24 - var4;
         var42 = var41.field_75991_b * 24 - var5;
         if(var40 >= -24 && var42 >= -24 && (float)var40 <= 224.0F * this.field_146570_r && (float)var42 <= 155.0F * this.field_146570_r) {
            ...
            if(var41.func_75984_f()) {
               this.func_73729_b(var40 - 2, var42 - 2, 26, 202, 26, 26);
            } else {
               this.func_73729_b(var40 - 2, var42 - 2, 0, 202, 26, 26);
            }

            if(!this.field_146556_E.func_77442_b(var41)) {
               var45 = 0.1F;
               GL11.glColor4f(var45, var45, var45, 1.0F);
               var38.field_77024_a = false;
            }

            GL11.glEnable(2896);
            GL11.glEnable(2884);
            var38.func_82406_b(this.field_146297_k.field_71466_p, this.field_146297_k.func_110434_K(), var41.field_75990_d, var40 + 3, var42 + 3);
            GL11.glBlendFunc(770, 771);
            GL11.glDisable(2896);
            if(!this.field_146556_E.func_77442_b(var41)) {
               var38.field_77024_a = true;
            }
      ...
      if(var34 != null) {
         ...
         String var39 = var34.func_75989_e();
         ...
         if(!this.field_146556_E.func_77442_b(var34)) {
            ...
            if(var30 == 3) {
               ...
               this.func_73733_a(var40 - 3, var42 - 3, var40 + var31 + 3, var42 + var33 + 12 + 3, -1073741824, -1073741824);
               this.field_146289_q.func_78279_b(var32, var40, var42 + 12, var31, -9416624);
            } else if(var30 < 3) {
               var31 = Math.max(this.field_146289_q.func_78256_a(var44), 120);
               var32 = (new ChatComponentTranslation("achievement.requires", new Object[]{var34.field_75992_c.func_150951_e()})).func_150260_c();
               var33 = this.field_146289_q.func_78267_b(var32, var31);
            ...
            var31 = Math.max(this.field_146289_q.func_78256_a(var44), 120);
            int var46 = this.field_146289_q.func_78267_b(var39, var31);
            if(this.field_146556_E.func_77443_a(var34)) {
               var46 += 12;
            }

            this.func_73733_a(var40 - 3, var42 - 3, var40 + var31 + 3, var42 + var46 + 3 + 12, -1073741824, -1073741824);
            this.field_146289_q.func_78279_b(var39, var40, var42 + 12, var31, -6250336);
            if(this.field_146556_E.func_77443_a(var34)) {
               this.field_146289_q.func_78261_a(I18n.func_135052_a("achievement.taken", new Object[0]), var40, var42 + var46 + 4, -7302913);
            }
         }

         if(var44 != null) {
            this.field_146289_q.func_78261_a(var44, var40, var42, this.field_146556_E.func_77442_b(var34)?(var34.func_75984_f()?-128:-1):(var34.func_75984_f()?-8355776:-8355712));
         }
      }
