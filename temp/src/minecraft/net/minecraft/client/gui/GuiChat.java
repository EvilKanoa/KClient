   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if(var4 != null && var4.func_150256_b().func_150210_i() != null) {
         ...
         if(var5.func_150701_a() == HoverEvent.Action.SHOW_ITEM) {
            ...
            StatBase var13 = StatList.func_151177_a(var5.func_150702_b().func_150260_c());
            if(var13 != null) {
               IChatComponent var12 = var13.func_150951_e();
               ChatComponentTranslation var8 = new ChatComponentTranslation("stats.tooltip.type." + (var13.func_75967_d()?"achievement":"statistic"), new Object[0]);
               var8.func_150256_b().func_150217_b(Boolean.valueOf(true));
               String var9 = var13 instanceof Achievement?((Achievement)var13).func_75989_e():null;
               ArrayList var10 = Lists.newArrayList(new String[]{var12.func_150254_d(), var8.func_150254_d()});
               if(var9 != null) {
