...
public final class ItemStack {
   ...
   public List func_82840_a(EntityPlayer p_82840_1_, boolean p_82840_2_) {
      ...
      if(this.func_77942_o()) {
         ...
         if(var14 != null) {
            for(var6 = 0; var6 < var14.func_74745_c(); ++var6) {
               short var7 = var14.func_150305_b(var6).func_74765_d("id");
               short var8 = var14.func_150305_b(var6).func_74765_d("lvl");
         ...
         if(this.field_77990_d.func_150297_b("display", 10)) {
            ...
            if(var17.func_150299_b("Lore") == 9) {
               NBTTagList var15 = var17.func_150295_c("Lore", 8);
               if(var15.func_74745_c() > 0) {
                  for(int var19 = 0; var19 < var15.func_74745_c(); ++var19) {
                     var3.add(EnumChatFormatting.DARK_PURPLE + "" + EnumChatFormatting.ITALIC + var15.func_150307_f(var19));
                  }
               }
            }
         }
      ...
      Multimap var13 = this.func_111283_C();
      if(!var13.isEmpty()) {
         var3.add("");
