               ...
               if(var5 > -1) {
                  ...
                  if(var7 != null) {
                     if(var5 == 0) {
                        ...
                        ItemArmor var11 = (ItemArmor)var4.func_77973_b();
                        ItemArmor var12 = (ItemArmor)var7.func_77973_b();
                        if(var11.field_77879_b == var12.field_77879_b) {
                           var6 = var4.func_77960_j() > var7.func_77960_j() || var4.func_77942_o() && !var7.func_77942_o();
                        } else {
                           var6 = var11.field_77879_b > var12.field_77879_b;
                        }
                     } else {
                        var6 = false;
                     }
                  ...
                  if(var6) {
                     ...
                     if(var4.func_77973_b() == Items.field_151045_i && var3.func_145800_j() != null) {
                        EntityPlayer var10 = this.field_70170_p.func_72924_a(var3.func_145800_j());
                        if(var10 != null) {
                           var10.func_71029_a(AchievementList.field_150966_x);
                        }
                     }
