...
public class DedicatedServer extends MinecraftServer implements IServer {
   ...
   public void func_70000_a(PlayerUsageSnooper p_70000_1_) {
      p_70000_1_.func_76472_a("whitelist_enabled", Boolean.valueOf(this.func_71203_ab().func_72383_n()));
      p_70000_1_.func_76472_a("whitelist_count", Integer.valueOf(this.func_71203_ab().func_72388_h().size()));
   ...
   public boolean func_96290_a(World p_96290_1_, int p_96290_2_, int p_96290_3_, int p_96290_4_, EntityPlayer p_96290_5_) {
      if(p_96290_1_.field_73011_w.field_76574_g != 0) {
         return false;
      } else if(this.func_71203_ab().func_72376_i().isEmpty()) {
         return false;
      } else if(this.func_71203_ab().func_72353_e(p_96290_5_.func_70005_c_())) {
         return false;
